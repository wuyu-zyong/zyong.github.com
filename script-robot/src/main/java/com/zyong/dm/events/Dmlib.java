...
public class Dmlib {
     ...
     * @return
     */
    protected static int KeyDownEvent(byte vkCode) {
        ComThread.InitSTA();
        int state = 0;
        dm = new ActiveXComponent("dm.dmsoft");//
        com = dm.getObject();
     ...
     * @return
     */
    protected static int KeyUpEvent(byte vkCode) {
        ComThread.InitSTA();
        int state = 0;
        dm = new ActiveXComponent("dm.dmsoft");//
        com = dm.getObject();
    ...
    protected static int KeyPressEvent(byte vkCode) {
        ComThread.InitSTA();
        dm = new ActiveXComponent("dm.dmsoft");//
        com = dm.getObject();
     ...
     */
    public static int[] GetClientRect(int hwnd) {
        int[] posi = new int[4];
        ComThread.InitSTA();
        dm = new ActiveXComponent("dm.dmsoft");//
        com = dm.getObject();
...
//        ComThread.Release();
     ...
     * @return
     */
    public static int[] GetClientSize(int hwnd) {
        int[] posi = new int[2];
        ComThread.InitSTA();
        dm = new ActiveXComponent("dm.dmsoft");//
        com = dm.getObject();
